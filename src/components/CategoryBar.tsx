...
export default function CategoryBar({
  ...
  return (
    <div 
      ...
      className="sticky top-[73px] sm:top-[85px] z-35 bg-white/90 dark:bg-[#080E10]/95 backdrop-blur-md border-b border-[#EBE7DF] dark:border-[#142225] py-2.5 px-3 sm:px-6 shadow-xs select-none transition-all"
    >
