  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="relative z-10 w-full max-w-lg bg-gradient-to-b from-[#0B1E21]/95 to-[#061214]/95 border-2 border-emerald-500/30 rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 shadow-2xl backdrop-blur-xl flex flex-col items-center text-center space-y-5 overflow-hidden my-auto"
      >
        ...
        <div className="space-y-2">
          <h1 className="text-2xl sm:text-3xl font-black font-kufi text-white tracking-tight leading-tight">
